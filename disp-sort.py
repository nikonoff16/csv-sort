...
def find_all_people(file_obj, years_dict):   # Индекс нужен чтобы программа сама находила нужные поля в таблице.
    ...
    # TODO - доделать обработчик регулярных выражений, чтобы как минимум переменная index не была нужна
    # Она сильно усложняет обработку списков, отличных от тех, что использованы в тестах.
    ...
    for row in reader:
        ...
        # Нерабочий блок поиска столбца даты.
        # elif first_string == 1:
